...
%options package=org.eclipse.imp.java.formatting.parser
...
%Rules
    ...
    Token ::= '$' '{' 'I' 'D' 'E' 'N' 'T' 'I' 'F' 'I' 'E' 'R' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_IDENTIFIER);
          $EndAction
        ./

    Token ::= '$' '{' 'B' 'l' 'o' 'c' 'k' 'S' 't' 'a' 't' 'e' 'm' 'e' 'n' 't' 's' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_BlockStatements);
          $EndAction
        ./

    Token ::= '$' '{' 'A' 'r' 'g' 'u' 'm' 'e' 'n' 't' 'L' 'i' 's' 't' 'o' 'p' 't' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_ArgumentListopt);
          $EndAction
        ./

    Token ::= '$' '{' 'A' 'r' 'g' 'u' 'm' 'e' 'n' 't' 'L' 'i' 's' 't' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_ArgumentList);
          $EndAction
        ./

    Token ::= '$' '{' 'S' 't' 'a' 't' 'e' 'm' 'e' 'n' 't' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_Statement);
          $EndAction
        ./

    Token ::= '$' '{' 'E' 'x' 'p' 'r' 'e' 's' 's' 'i' 'o' 'n' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_Expression);
          $EndAction
        ./

    Token ::= '$' '{' 'T' 'y' 'p' 'e' 'D' 'e' 'c' 'l' 'a' 'r' 'a' 't' 'i' 'o' 'n' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_TypeDeclaration);
          $EndAction
        ./

    Token ::= '$' '{' 'I' 'm' 'p' 'o' 'r' 't' 'D' 'e' 'c' 'l' 'a' 'r' 'a' 't' 'i' 'o' 'n' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_ImportDeclaration);
          $EndAction
        ./

    Token ::= '$' '{' 'I' 'm' 'p' 'o' 'r' 't' 'D' 'e' 'c' 'l' 'a' 'r' 'a' 't' 'i' 'o' 'n' 's' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_ImportDeclarations);
          $EndAction
        ./

    Token ::= '$' '{' 'C' 'l' 'a' 's' 's' 'B' 'o' 'd' 'y' 'D' 'e' 'c' 'l' 'a' 'r' 'a' 't' 'i' 'o' 'n' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_ClassBodyDeclaration);
          $EndAction
        ./

    Token ::= '$' '{' 'P' 'a' 'c' 'k' 'a' 'g' 'e' 'N' 'a' 'm' 'e' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_PackageName);
          $EndAction
        ./

    Token ::= '$' '{' 'T' 'y' 'p' 'e' 'N' 'a' 'm' 'e' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_TypeName);
          $EndAction
        ./

    Token ::= '$' '{' 'M' 'e' 't' 'h' 'o' 'd' 'N' 'a' 'm' 'e' IntegerOpt '}'
        /.$BeginAction
                    makeToken($_VAR_MethodName);
          $EndAction
        ./
