...
%Start
    CompilationUnit PackageDeclaration ImportDeclarations ImportDeclaration TypeDeclaration ClassBodyDeclaration
    BlockStatements TypeName PackageName ArgumentList Statement Expression MethodInvocation
%End
...
%Rules
    Statement$StatementMetaVar ::= VAR_Statement

    BlockStatements$BlockStatementMetaVar ::= VAR_BlockStatements

    Expression$ExpressionMetaVar ::= VAR_Expression

    TypeDeclaration$TypeDeclarationMetaVar ::= VAR_TypeDeclaration

    ArgumentListopt$ArgumentListoptMetaVar ::= VAR_ArgumentListopt

    ArgumentList$ArgumentListMetaVar ::= VAR_ArgumentList

    ImportDeclaration$ImportDeclarationMetaVar ::= VAR_ImportDeclaration

    ImportDeclarations$ImportDeclarationsMetaVar ::= VAR_ImportDeclarations

    ClassBodyDeclaration$ClassBodyDeclarationMetaVar ::= VAR_ClassBodyDeclaration

    PackageName$PackageNameMetaVar ::= VAR_PackageName

    TypeName$TypeNameMetaVar ::= VAR_TypeName

    MethodName$MethodNameMetaVar ::= VAR_MethodName

    identifier$IdentifierMetaVar ::= VAR_IDENTIFIER
